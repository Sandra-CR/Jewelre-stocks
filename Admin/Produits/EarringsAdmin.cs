...
{
    public partial class EarringsAdmin : Form
    {
        public EarringsAdmin()
        {
            InitializeComponent();
        }

        // Fonction au chargement de la page
        private void EarringsAdmin_Load(object sender, EventArgs e)
        {
            DGV.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            DGV2.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            DGV3.SelectionMode = DataGridViewSelectionMode.FullRowSelect;

            DGV.DataSource = Admin.AfficherEarrings();
        }
        ...
        private void searchBar_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string Sql = "SELECT id, prix, en_vente, matiere_p, couleur_p, titrage, matiere_s, couleur_s, motif, fermoir, id_genre, id_fournisseur FROM produit " +
                    "WHERE type_produit = 'Boucles d''oreilles' AND (" +
                    "id LIKE @Content OR " +
