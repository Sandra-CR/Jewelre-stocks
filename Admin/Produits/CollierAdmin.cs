...
{
    public partial class CollierAdmin : Form
    {
        public CollierAdmin()
        {
            InitializeComponent();
        ...
        private void CollierAdmin_Load(object sender, EventArgs e)
        {
            DGV.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            DGV2.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            DGV3.SelectionMode = DataGridViewSelectionMode.FullRowSelect;

            DGV.DataSource = Admin.AfficherCollier();
        }
        ...
        private void searchBar_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string Sql = "SELECT id, prix, en_vente, matiere_p, couleur_p, titrage, matiere_s, couleur_s, chaine, fermoir, id_genre, id_fournisseur FROM produit " +
                    "WHERE type_produit = 'Collier' AND (" +
                    "id LIKE @Content OR " +
